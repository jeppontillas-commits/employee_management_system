...
@section('title', 'Create Audit Record')

@section('content')
<div class="container-fluid">
    <h2 class="mb-4"><i class="fas fa-plus-circle"></i> Create Audit Record</h2>
        ...
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('audit-records.store') }}" method="POST">
                        @csrf
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control @error('action_description') is-invalid @enderror" 
                                      id="action_description" name="action_description" rows="4">{{ old('action_description') }}</textarea>

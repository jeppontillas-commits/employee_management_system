...
@section('title', 'Create Profile History')

@section('content')
<div class="container-fluid">
    <h2 class="mb-4"><i class="fas fa-plus-circle"></i> Create Profile History</h2>
        ...
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('employee-profile-histories.store') }}" method="POST">
                        @csrf
                        ...
                        <div class="form-group">
                            ...
                            <input type="datetime-local" class="form-control @error('changed_date') is-invalid @enderror" 
                                   id="changed_date" name="changed_date" value="{{ old('changed_date', now()->format('Y-m-d\TH:i')) }}" required>
                            @error('changed_date')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control @error('history_data') is-invalid @enderror" 
                                      id="history_data" name="history_data" rows="4">{{ old('history_data') }}</textarea>
                            @error('history_data')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="form-group">
                            <button type="submit" class="btn btn-primary">
                                <i class="fas fa-save"></i> Create History
                            </button>
